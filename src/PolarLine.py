...
# datastruct for line in theta r format
BaseLine = namedtuple("BaseLine", 
                       ["start", "end", "theta", "r", "length"])
...
def line_to_theta_r(start, end):
    ...
    return PolarLine(start, end, theta, r, line_length(start, end))
...
def make_lines():
    ...
    lines = []
    lines.append(
        PolarLine((80,194), (41,125), 0.514451313, 25.8140807, 79.25906888))
    lines.append(
        PolarLine((90,208), (138,122), -0.509070888, 179.9599543, 98.48857802))
    lines.append(
        PolarLine((47,135), (35,113), 0.499346722, 23.38394571, 25.059928))
    lines.append(
        PolarLine((35,112), (87,19), -0.509833229, 85.20845626, 106.5504575))
    lines.append(
        PolarLine((133,95), (112,56), 0.493941369, 72.0631731,   44.29446918))
    lines.append(
        PolarLine((86,206), (69,175), 0.501604054, 23.64565076,  35.35533906))
    lines.append(
        PolarLine((117,161), (143,114),  -0.505290188, 180.312866,   53.71219601))
    lines.append(
        PolarLine((114,61),  (98,32),     0.504165961, 70.34813806,  33.12099032))
    lines.append(
        PolarLine((104,42),  (91,19),     0.514451313, 69.87213045,  26.41968963))
    lines.append(
        PolarLine((143,112), (130,88),    0.496422753, 72.39503858, 27.29468813))
