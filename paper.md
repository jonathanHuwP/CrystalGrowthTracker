...
We have produced a video giving a  full description of the installation and operation of the package [@installVid]. Also the data video used in the instructional video is avaliable via Zenodo [@zenodoSample].
